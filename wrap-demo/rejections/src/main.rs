...
// curl "http://127.0.0.1:3000/math/8" -H "div-by: 2"
// curl "http://127.0.0.1:3000/math/8" -H "div-by: 0"
// curl -X POST "http://127.0.0.1:3000/math/8" -d '{ "denom":2 }' -H "Content-Type: application/json"
// curl -X POST "http://127.0.0.1:3000/math/8" -d '{ "denom":0 }' -H "Content-Type: application/json"
