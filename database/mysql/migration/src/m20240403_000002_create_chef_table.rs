// m20240403_000002_create_chef_table.rs

use sea_orm_migration::prelude::*;

use super::m20240403_000001_create_bakery_table::Bakery;

pub struct Migration;

impl MigrationName for Migration {
    fn name(&self) -> &str {
        "m_20240403_000002_create_chef_table" // Make sure this matches with the file name
    }
}
